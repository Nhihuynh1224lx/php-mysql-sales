...
<main class="container py-5">
    ...
    <a href="/products.php" class="text-decoration-none d-inline-block mb-4">
    ...
    <div class="row g-5">
        ...
        <div class="col-lg-6">
            ...
            <?php if (!empty($images)): ?>
                ...
                <!-- Ảnh lớn: ảnh chính (đã được xếp lên đầu) -->
                <div
                    class="bg-light d-flex align-items-center
                           justify-content-center p-3 mb-3 rounded"
                    style="height: 420px;"
                >

                    <img
                        src="/uploads/products/<?=
                            htmlspecialchars($images[0]['ImageFile'])
                        ?>"
                        ...
                        <?php foreach ($images as $image): ?>
                            ...
                            <div class="col-4">
                                ...
                                >
                                    ...
                                    <img
                                        src="/uploads/products/<?=
                                            htmlspecialchars($image['ImageFile'])
                                        ?>"
                                        alt="<?=
                                            htmlspecialchars(
                                                $product['ProductName']
            ...
            <?php else: ?>
                ...
                <div
                    class="bg-light d-flex align-items-center
                           justify-content-center text-muted rounded"
                    style="height: 420px;"
                >
                    Chưa có hình ảnh
                </div>
